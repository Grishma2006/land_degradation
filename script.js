...
const I18N = {
  ...
  hi: {
    ...
    home_card_prev_desc:"मिट्टी की रक्षा व सुधार के लिए सरल, पर्यावरण-अनुकूल उपाय खोजें।",
  ...
  mr: {
    ...
    soil_sandy:"वाळूमिश्रित", soil_sandy_desc:"वाळूमिश्रित माती पाणी पटकन गाळते. कंपोस्ट व वारंवार हलकी सिंचन उपयुक्त.",
...
function speakText(text, lang){
  ...
  // Marathi fallback → use Hindi (hi-IN)
  let voiceLang =
    lang === "mr" ? "hi-IN" :
    lang === "hi" ? "hi-IN" :
    "en-US";
  ...
  let selected = voices.find(v => v.lang.startsWith(voiceLang));

  if(!selected){
    console.warn("No suitable voice, using default.");
    selected = voices[0];
  }
  ...
  // FIX: Delay to ensure voices are loaded
  setTimeout(() => {
